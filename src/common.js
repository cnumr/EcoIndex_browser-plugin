...
export const FETCH_RESULT_URL = (url, refresh = false) =>
	`${apiUrl}/results/?url=${url}&refresh=${refresh}`;
...
export const FETCH_RESULT_ECOINDEX_URL = (id) =>
	`${ecoindexUrl}/resultat/?id=${id}`;
